...
// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	//#define PP_ID		"PP_3000" 		// Purr Pleaser ID (Note, a unique HA ID is automatically generated with the device MAC Address.)
	#define PP_NAME		"Cat Feeder"	// Purr Pleaser Name (as shown at home assistant)
	#define VERSION		"0.1.2"			// Version of the Purr Pleaser
	#define PP_MODEL	"PP3000D"		// Model (e.g. PP3000S for Single Feeder, PP3000D for Double Feeder)
	...
	#define	EXPANDER			true		// Use expander (true) or not (false); if false settings below are ignored
	#define MCP_ADDRESS			0x20		// Port expander address
	#define MCP_INTA			15			// Interrupt pin A - IMPORTANT: SET TO 1 FOR HOMING WITHOUT MCP23017!!!
	...
	#define CURRENT				800			// Max current (mA) supplied to the motor
	...
	#define	DRIVER_ADDRESS_1	0b01		// Drivers address			
	...
	#define	DRIVER_ADDRESS_2	0b10		// Drivers address			
	...
	#define DATA_PIN_2			13			// Data pin for scale 2
	#define CLOCK_PIN_2			14			// Clock pin for scale 2
